$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '题目', name: 'title', index: 'title', width: 80 }, 			
...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.questions.id == null ? "questions/save" : "questions/update";
			$.ajax({
				type: "POST",
			    url: url,
		...
		getInfo: function(id){
			$.get("questions/info/"+id, function(r){
